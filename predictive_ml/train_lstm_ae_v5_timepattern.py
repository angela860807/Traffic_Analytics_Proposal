...
METRICS_PATH   = "model/metrics_v5_timepattern_thr999.json"
...
def load_and_preprocess():
    print("\n[1] 데이터 로드 중...")
    df_normal = pd.read_csv("data/normal_samples5_timepattern.csv")
    df_fault  = pd.read_csv("data/fault_samples5_timepattern.csv")
