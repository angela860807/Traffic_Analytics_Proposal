...
입력:
  data/fault_samples2.csv
  model/lstm_ae_v2_ep25_thr999.pt
  model/scaler_v2.pkl
  model/threshold_v2_ep25_thr999.json

출력:
  results/lead_time_report_v2.csv
  results/scenario_metrics_v2.csv
  results/evaluation_summary_v2.json
"""
...
FAULT_DATA     = "data/fault_samples2.csv"
...
def measure_lead_time(model, scaler, warning_thr, df_fault):
    ...
    df_lead.to_csv("results/lead_time_report_v2.csv", index=False)
    print(f"\n  저장 완료: results/lead_time_report_v2.csv")
    return df_lead
...
def analyze_by_scenario(model, scaler, warning_thr, df_fault):
    ...
    df_scenario.to_csv("results/scenario_metrics_v2.csv", index=False)
    print(f"\n  저장 완료: results/scenario_metrics_v2.csv")
    return df_scenario
...
def save_summary(df_lead, df_scenario, warning_thr, critical_thr):
    ...
    print(f"\n  저장 완료: results/evaluation_summary_v2.json")
    return summary
...
def main():
    ...
    print("═" * 50)
    print("\n결과 파일:")
    print("  results/lead_time_report_v2.csv")
    print("  results/scenario_metrics_v2.csv")
